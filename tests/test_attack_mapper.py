...
def example_data_comp_by_id():
    return json.loads('''
    {
        "x-mitre-data-component--3d20385b-24ef-40e1-9f56-f39750379077": {
            ...
            "description": "Refers to the event in which a new process (executable) ...",
        ...
        "objects": [
            {
                ...
                "external_references": [
                    ...
                    },
                    {
                        ...
                        "description": "Campbell, B. et al. (2022, March 21)...Retrieved April 11, 2022.",
            ...
            },
            {
                ...
                "external_references": [
                    ...
                    },
                    {
                        ...
                        "description": "US-CERT. (2018, April 20)... Retrieved October 19, 2020.",
            ...
            },
            {
                ...
                "modified": "2025-11-12T22:03:39.105Z",
                "name": "Analytic 1025",
                "description": "Detection of domain group ...",
                "x_mitre_modified_by_ref": "identity--c78cb6e5-0c4b-4611-8297-d1b8b55e40b5",
                "x_mitre_deprecated": false,
                "x_mitre_version": "1.0",
                "x_mitre_attack_spec_version": "3.3.0",
            ...
            },
            {
                ...
                "modified": "2025-11-12T22:03:39.105Z",
                "name": "Process Creation",
                "description": "Refers to the event in which a new process (executable) is initialized by an ...",
                "x_mitre_data_source_ref": "",
                "x_mitre_modified_by_ref": "identity--c78cb6e5-0c4b-4611-8297-d1b8b55e40b5",
                "x_mitre_deprecated": false,
                "x_mitre_domains": [
            ...
            },
            {
                ...
                "modified": "2025-11-12T22:03:39.105Z",
                "name": "File Creation",
                "description": "A new file is created on a system or network storage. .... ",
                "x_mitre_data_source_ref": "",
                "x_mitre_modified_by_ref": "identity--c78cb6e5-0c4b-4611-8297-d1b8b55e40b5",
                "x_mitre_deprecated": false,
                "x_mitre_domains": [
    ...
    return json.loads('''
    {
        ...
        "external_references": [
            ...
            },
            {
                ...
                "description": "Hosseini, A. (2017, July 18). ... Retrieved December 7, 2017.",
        ...
        "x_mitre_attack_spec_version": "3.2.0",
        "x_mitre_deprecated": false,
        "x_mitre_detection": "Monitor for API calls related to enumerating and manipulating EWM such as...",
        "x_mitre_domains": [
            "enterprise-attack"
        ],
        "x_mitre_is_subtechnique": true,
